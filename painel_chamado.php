    ...
    if($sql->rowCount() > 0){
        foreach($sql->fetchAll() as $chamado) {
            ...
            if ($chamado['tecnico'] <= 0) {
                ...
                echo '<th><a href= "visualiza_chamado.php?id=' . base64_encode($chamado['id_chamado']) . '">Visualizar</a> - <a href= "pegar.php?id=' . base64_encode($chamado['id_chamado']) . '">Atender</a></th>';
            }
                echo '</tr>';
            }
    }
